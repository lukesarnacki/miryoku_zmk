...
#define HOME_A U_MT(LCTRL, A)
#define HOME_S U_MT(LALT, S)
#define HOME_D U_MT(LGUI, D)
#define HOME_F U_MT(LSHIFT, F)

// Right-hand home row mods
#define HOME_J U_MT(RSHIFT, J)
#define HOME_K U_MT(RGUI, K)
#define HOME_L U_MT(LALT, L)
#define HOME_SEMI U_MT(LCTRL, SEMI)
...
#define LAYER_BASE_NIX \
&kp Q,             U_MT(RALT, W),             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             U_MT(RALT, O),             &kp P,             \
HOME_A,     HOME_S,     HOME_D,    HOME_F,    &kp G,             &kp H,             HOME_J,    HOME_K,    HOME_L,     HOME_SEMI,   \
U_LT(U_BUTTON, Z), &kp X,     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         &kp DOT,   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, ESC),  U_LT(U_SYM2, BSPC), U_LT(U_NAV, TAB),  U_LT(U_NUM, RET),U_LT(U_SYM, SPACE),U_LT(U_MOUSE, DEL),U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              U_LT(U_MEDIA, RET),           &kp SPACE,          &kp DEL,           U_NP,              U_NP

#define LAYER_SYM2_NIX \
U_BOOT,            &kp RALT,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_NA,     &kp LBRC,          &kp RBRC,    &kp PLUS,   &kp PIPE,          \
&kp LCTRL,          &kp LALT,          &kp LGUI,         &kp LSHFT,         U_NA,           U_NA,   &kp LBKT,          &kp RBKT,          &kp DQT,         &kp SQT,        \
...
&kp EQUAL,         &kp CARET,          &kp MINUS,         &kp UNDER,         &kp DLLR,          U_NA,              &kp LSHFT,         &kp LGUI,         &kp LALT,          &kp LCTRL,          \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              &kp C_STOP,         &kp C_PP,         &kp C_MUTE,         U_NA,         U_RGB_TOG,         \
