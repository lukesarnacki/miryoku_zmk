...
#define HOME_A U_MT(LGUI, A)
#define HOME_S U_MT(LALT, S)
#define HOME_D U_MT(LCTRL, D)
#define HOME_F U_MT(LSHIFT, F)

// Right-hand home row mods
#define HOME_J U_MT(RSHIFT, J)
#define HOME_K U_MT(RCTRL, K)
#define HOME_L U_MT(LALT, L)
#define HOME_SEMI U_MT(LGUI, SEMI)
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,           U_NA,   &kp LBKT,          &kp RBKT,          &kp DQT,         &kp SQT,        \
